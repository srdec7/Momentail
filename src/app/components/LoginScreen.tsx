...
export function LoginScreen({ onLogin }: Props) {
  ...
  return (
    <div className="relative w-full h-full overflow-y-auto flex flex-col font-sans">
      ...
      <div className="relative z-10 flex flex-col items-center mt-4 mb-2 px-6 text-center">
        <motion.div
          animate={{ y: [0, -8, 0] }}
      ...
      <div className="flex-1 flex flex-col justify-start px-5 relative z-10 pt-[115px]">
        <motion.div
