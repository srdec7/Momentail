...
export const TRACKS: Track[] = [
  ...
  { id: 3,  category: 'sleep',   titleKO: '딥 슬립 화이트 노이즈', titleEN: 'Deep Sleep White Noise', duration: '2:34', free: false, color: '#9B7BC8', audioUrl: '/audio/sleep3.mp3' },
  ...
  { id: 6,  category: 'sleep',   titleKO: '깊은 꿈나라 여행',   titleEN: 'Deep Dream Journey',    duration: '3:04', free: false, color: '#9B7BC8', audioUrl: '/audio/sleep6.mp3' },
  ...
  { id: 8,  category: 'anxiety', titleKO: '냇물 흐르는 소리',  titleEN: 'Flowing Creek',         duration: '2:38', free: false, color: '#5BAD6F', audioUrl: '/audio/Anxiety2.mp3' },
  { id: 9,  category: 'anxiety', titleKO: '캠프파이어',        titleEN: 'Campfire Crackle',      duration: '1:03', free: false, color: '#5BAD6F', audioUrl: '/audio/Anxiety3.mp3' },
  ...
  { id: 17, category: 'focus',   titleKO: '도서관 앰비언스',   titleEN: 'Library Ambience',      duration: '1:40', free: false, color: '#7CB9E8', audioUrl: '/audio/focus5.mp3' },
  { id: 18, category: 'focus',   titleKO: '딥 워크 비트',      titleEN: 'Deep Work Beats',       duration: '2:07', free: false, color: '#7CB9E8', audioUrl: '/audio/focus6.mp3' },
  ...
  { id: 26, category: 'daily',   titleKO: '저녁 산책 비트',   titleEN: 'Evening Walk',          duration: '2:12', free: false, color: '#C4A875', audioUrl: '/audio/daily2.mp3' },
              ...
              return (
                ...
                >
                  <div
                    ...
                    style={{ background: isLocked ? 'rgba(255,255,255,0.05)' : `${t.color}22` }}
                  >
                    {isLocked
                      ? <Lock size={12} style={{ color: 'rgba(220,215,201,0.3)' }} />
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium" style={{ color: isLocked ? 'rgba(220,215,201,0.3)' : isCurrent ? t.color : 'rgba(220,215,201,0.8)' }}>
                      {KO ? t.titleKO : t.titleEN}
                    </p>
                    <p className="text-[11px]" style={{ color: 'rgba(220,215,201,0.25)' }}>{t.duration}</p>
                  </div>
                  {isLocked && (
                    <span className="text-[10px] px-1.5 py-0.5 rounded-full" style={{ background: 'rgba(162,123,92,0.2)', color: '#A27B5C' }}>
                      PRO
                    </span>
                  )}
                </button>
