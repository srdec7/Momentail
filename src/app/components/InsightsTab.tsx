                ...
                <div id="vip-report-content" className="flex flex-col bg-white">
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-6 p-4 rounded-xl bg-gray-50 border border-gray-100 text-[10px] text-gray-400 leading-relaxed">
                      <p>
                        {KO 
                          ? "* 본 리포트는 Petory DogEngine AI가 사용자의 기록을 바탕으로 생성한 건강 참고 자료이며, 수의사의 진단을 대신할 수 없습니다. 참고 문헌: 일반적인 반려동물 관리 지침 (AVMA, AKC 등). 이상 징후가 의심될 경우 동물병원을 방문하세요."
                          : "* This report is a health reference generated by Petory DogEngine AI. It is not a substitute for professional veterinary diagnosis. References: General pet care guidelines (e.g., AVMA, AKC). Please visit a veterinary clinic if you suspect health issues."}
                      </p>
                    </div>
                  </div>
                </div>
